...
function updateCartQuantity(){
  document.querySelector('.js-quantity-shown').innerHTML = `${calculateCartQuantity()} items`;
}
...
function updatingInfo(productId){
  const newQuantityInput = document.querySelector(`.quantity-input`);
